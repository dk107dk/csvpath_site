...
For more background, you can [read more about named-paths and named-files here](../../higher-level-topics/data-validation-files-and-storage/named_files_and_paths.md).&#x20;
