...
We'll use the example from [Another Example](../a-longer-example/another-example-part-2.md). First create a Poetry project. You can use Pip or any tool you like, but we like Poetry. In the terminal do:
...
Now we'll copy the files from the [Another Example](../a-longer-example/another-example-part-2.md) pages. The ones attached here are slightly updated so use them, even if you did the example and have your own.&#x20;
...
Here are the possible directives with possible values and/or examples. You can [learn more about CKAN directives here](ckan-csvpath-setup.md).
...
Yes, that's a lot! You won't use them all, and very likely you will come to appreciate the flexibility. When you are first getting started you may want to have the [docs page](ckan-csvpath-setup.md) at hand.
