...
There is more to it, of course. You can read about references and rewind/replay [here](replay-using-references.md), [here](how-tos/rewind-replay-part-1/), and [here](the_reference_data_types.md) — and there is an example of doing rewind/replay specifically in the CLI [here](how-tos/rewind-replay-part-1/rewind-replay-part-2.md), including a video of actually doing it.
