...
Named-paths are more interesting. The goal with named-paths is for us to be able to easily run multiple csvpaths against a single file in one go. The attraction to that is primarily that you can segment your validations into separate and composable csvpaths.  As discussed in [Validation Strategies](../validation/validation_strategies.md) and [Another Example, Part 2](../how-tos/a-longer-example/another-example-part-2.md), separate cvpaths can be important to:&#x20;
...
There is a table of the advantages of each approach [here](../how-tos/a-longer-example/another-example-part-2.md).
