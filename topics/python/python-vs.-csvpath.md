...
In [Another Example, Part 1](../how-tos/a-longer-example/another-example-part-1.md) and [Another Example, Part 2](../how-tos/a-longer-example/another-example-part-2.md) we created a CsvPath validation for a simplified retail goods order file. The rules were:&#x20;
...
And without further ado, here's the Python implementation to compare to [Another Example, Part 2](../how-tos/a-longer-example/another-example-part-2.md). Put your DataOps engineering manager hat on and judge for yourself.  &#x20;
