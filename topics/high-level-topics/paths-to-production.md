...
And we can repurpose the multi-csvpath file from [Another Example, Part 2](../how-tos/another-longer-example/another-example-part-2.md) to stand in for your inbound file validation rules.
