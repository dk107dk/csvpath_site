...
As you saw in [Your First Validation](../../getting-started/more-csv-and-excel-validation/your-first-validation.md) and [Another Example Part 2](../how-tos/a-longer-example/another-example-part-1.md), there are two ways to use the CsvPath library.&#x20;
...
And we can repurpose the multi-csvpath file from [Another Example, Part 2](../how-tos/a-longer-example/another-example-part-2.md) to stand in for your inbound file validation rules.
