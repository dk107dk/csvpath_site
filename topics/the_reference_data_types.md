...
* [Seven Types Of Data](the_reference_data_types.md#four-types-of-data)
...
* `files` indicates that the reference is [a pointer to a named-file version as described here](how-tos/rewind-replay/referring-to-named-file-versions.md)
