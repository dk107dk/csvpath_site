...
The CsvPath language, and its Python library, is simple, easy to integrate, and flexible enough to handle the unexpected quirks of CSV and Excel data. Inspired by [Schematron](https://schematron.com/) and [XPath](https://www.w3.org/TR/xpath-31/), CsvPath brings rules-based data validation to less structured data.
