...
We'll use the example from [Another Example](../../topics/how-tos/another-example-part-2.md). First create a Poetry project. You can use Pip or any tool you like, but we like Poetry. In the terminal do:
...
Now we'll copy the files from the [Another Example](../../topics/how-tos/another-example-part-2.md) pages. The ones attached here are slightly updated so use them, even if you did the example and have your own.&#x20;
