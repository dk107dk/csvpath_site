...
Here are the possible directives with possible values and/or examples. You can [learn more about CKAN directives here](../how-tos/sending-results-to-ckan.md).
...
Yes, that's a lot! You won't use them all, and very likely you will come to appreciate the flexibility. When you are first getting started you may want to have the [docs page](../how-tos/sending-results-to-ckan.md) at hand.
