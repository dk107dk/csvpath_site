...
* **Set up CsvPath projects for new data vendors in seconds** using the [FlightPath Data](getting-started/get-the-flightpath-data-app.md) app
...
Try CsvPath Framework as a Python library or in the [FlightPath Data](getting-started/get-the-flightpath-data-app.md) app for MacOS or Windows.
